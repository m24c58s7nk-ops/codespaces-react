...
export default function App() {
  ...
  return <main className="app">
    ...
    {showEventForm && <section className="event-form"><h2>Add event</h2><input placeholder="Event name" value={eventName} onChange={e => setEventName(e.target.value)} /><label>Date<input type="date" value={eventDate} onChange={e => setEventDate(e.target.value)} /></label><div className="time-grid"><label>Starts<input type="time" value={eventStart} onChange={e => setEventStart(e.target.value)} /></label><label>Ends<input type="time" value={eventEnd} onChange={e => setEventEnd(e.target.value)} /></label></div><label>Leave at<input type="time" value={eventLeave} onChange={e => setEventLeave(e.target.value)} /></label><input placeholder="Location (optional)" value={eventLocation} onChange={e => setEventLocation(e.target.value)} /><textarea placeholder="Notes (optional)" value={eventNotes} onChange={e => setEventNotes(e.target.value)} /><button className="add-button" onClick={addEvent}>Create event</button></section>}
    ...
    <section className="add-section"><h2>Add an item</h2><input placeholder="What do you need?" value={itemName} onChange={e => setItemName(e.target.value)} /><input placeholder="Where is it?" value={itemLocation} onChange={e => setItemLocation(e.target.value)} /><button className="add-button" onClick={addItem}>Add item</button></section>
  </main>
}
