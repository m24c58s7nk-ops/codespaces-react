...
export default function App() {
  ...
  if (page === "profile") return <Layout><button className="back-button" onClick={() => setPage("home")}>← Home</button><section className="profile-card"><div className="profile-avatar">G</div><h1>Guest</h1><p className="date">Guest account</p><p>Sign up to save your events and track your progress across devices.</p><button className="add-button" onClick={() => setPage("settings")}>Account settings</button></section></Layout>
