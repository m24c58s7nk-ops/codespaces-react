...
export default function App() {
  ...
  if (selectedEvent) {
    ...
    return <main className="app">
      ...
      <section className="event-detail">
        ...
        {selectedEvent.repeat !== "none" && <p className="event-time">Repeats {selectedEvent.repeat}</p>}
  ...
  return <main className="app">
    <header className="top-bar"><div className="brand-row"><div className="app-logo" aria-label="Paratus logo">✓</div><div><p className="eyebrow">PARATUS</p><h1>Today</h1><p className="date">{new Date().toLocaleDateString([], { weekday: "long", month: "long", day: "numeric" })}</p></div></div></header>
